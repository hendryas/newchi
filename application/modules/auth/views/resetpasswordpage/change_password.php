                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="text-center mt-0 m-b-15">
                                    <a href="<?php echo base_url(); ?>auth" class="logo logo-admin"><img src="<?php echo base_url(); ?>assets/images/logo_newchi_medium.png" height="130" alt="logo"></a>
                                </h3>
                                ...
                                <div class="p-3">
                                    <form class="form-horizontal m-t-20" method="POST" action="<?php echo base_url(); ?>auth/resetpassword/changepassword">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="password" class="pr-password form-control" placeholder="Password" name="password1" id="password1" data-toggle="password">
                                                <small class="text-danger"><?php echo form_error('password1'); ?></small>
                                            </div>
                                            <div class="col">
                                                <label for="password2">Repeat Password<span>*</span></label>
                                                <input type="password" class="form-control" placeholder="Repeat Password" name="password2" id="password2" data-toggle="password">
